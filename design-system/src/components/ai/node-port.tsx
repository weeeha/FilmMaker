...
const portConfig = {
  ...
  audio: { icon: Music, label: "Audio", color: "blue" },
  speech: { icon: Speech, label: "Speech", color: "blue" },
  sound: { icon: Volume2, label: "Sound", color: "purple" },
  "3d": { icon: Box, label: "3D", color: "blue" },
  avatar: { icon: UserRound, label: "Avatar", color: "blue" },
  "start-frame": { icon: FlipHorizontal, label: "Start frame", color: "blue" },
  "end-frame": { icon: FlipHorizontal, label: "End frame", color: "blue" },
  text: { icon: Type, label: "Text", color: "neutral" },
  link: { icon: Link2, label: "Link", color: "blue" },
} satisfies Record<
  string,
  { icon: React.ElementType; label: string; color: "blue" | "purple" | "neutral" }
>
